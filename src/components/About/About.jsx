        ...
        <div className="row gy-5">
          <div className="col-lg-7 col-xl-8 text-center text-lg-start">
            <h2 className="text-7 fw-600 mb-3 ">
              I'm <span className="text-primary">Abdul Kader Midlaj,</span> a Web
              Developer{" "}
            </h2>
            <p>
            ...
            <p className="">
              Holding a Bachelor of engineering (B.E) degree with 2 years of extensive experience
              in UI development, my area of expertise includes HTML, CSS, JavaScript/Jquery, ReactJS,
              SCSS/SASS/LESS, Json, Web Accessibility, Responsive Design, HTMl email template, NextJs.
              <br />
